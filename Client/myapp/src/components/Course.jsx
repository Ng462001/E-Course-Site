    ...
    <div>
      ...
      <div>
        ...
        <section className="courses">
          ...
          <div className='text-center mt-5'><Link className='btn btn-primary text-white font-weight-bolder float-right enroll1 text-center' to="/course">View All</Link></div>
        </section>
      </div>
    </div>
  );
